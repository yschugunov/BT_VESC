// Motor Configuration for Flipsky 7070/110kv
// Based on actual Flipsky 7070 motor specifications
// 12N14P structure, 14 pole pairs, rated for 4200W

#ifndef MCCONF_FLIPSKY_7070_110KV_H_
#define MCCONF_FLIPSKY_7070_110KV_H_
...
// Motor Type (0=outrunner)
#define MCCONF_DEFAULT_MOTOR_TYPE 0

// Sensor Mode
#define MCCONF_SENSOR_MODE 0

// Motor Current Max (Flipsky 7070 rated for 100A max, but 65A sustained is safer)
#define MCCONF_L_CURRENT_MAX 65

// Motor Current Max Brake (60% of motor max for safety)
#define MCCONF_L_CURRENT_MIN -55

// Battery Current Max (48V * 65A = 3120W practical limit)
#define MCCONF_L_IN_CURRENT_MAX 60

// Battery Current Max Regen
#define MCCONF_L_IN_CURRENT_MIN -1

// Absolute Maximum Current (100A absolute max for Flipsky 7070)
#define MCCONF_L_MAX_ABS_CURRENT 100

// Max ERPM Reverse
#define MCCONF_L_RPM_MIN -100000

// Max ERPM (110kv * 48V theoretical = 5280 RPM, in ERPM: 5280 * 7 poles = 36960 ERPM)
#define MCCONF_L_RPM_MAX 40000
...
// Maximum Wattage (65A * 48V = 3120W practical)
#define MCCONF_L_WATT_MAX 3120

// Maximum Braking Wattage
#define MCCONF_L_WATT_MIN -1560
...
// Current KP (FOC proportional gain - tuned for 7070)
#define MCCONF_FOC_CURRENT_KP 0.0331

// Current KI (FOC integral gain)
...
// Motor Inductance (L) - Flipsky 7070 typical ~50 uH
#define MCCONF_FOC_MOTOR_L 0.00005

// Motor Resistance (R) - Flipsky 7070 actual spec: 0.055 Ohm
#define MCCONF_FOC_MOTOR_R 0.055

// Motor Flux Linkage (λ) - estimated for 110kv Flipsky 7070
#define MCCONF_FOC_MOTOR_FLUX_LINKAGE 0.0158
...
// Motor Poles (Flipsky 7070: 14 poles = 7 pole pairs)
#define MCCONF_SI_MOTOR_POLES 7
...
#endif // MCCONF_FLIPSKY_7070_110KV_H_
